...
public class OdltestCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(OdltestCliTestCommand.class);
    protected final OdltestCliCommands service;

    public OdltestCliTestCommand(final OdltestCliCommands service) {
